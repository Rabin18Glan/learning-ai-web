...
import { ArrowLeft, BookOpen, MessageSquare, FileText, Settings, Plus, Tag } from "lucide-react"
...
export default function LearningPathPage() {
  ...
  if (!learningPath) {
    return (
      <div className="container py-8 text-center">
        ...
        <Button onClick={() => router.push("/learning-paths")}>Back to Learning Paths</Button>
      </div>
    )
  }
  ...
  return (
    <div className="container py-8">
      <div className="flex items-center mb-6">
        <Button variant="ghost" size="icon" onClick={() => router.push("/learning-paths")} className="mr-4">
          <ArrowLeft className="h-5 w-5" />
        </Button>
